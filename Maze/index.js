...
// Reloads the page when 'R' key is presses
document.querySelector(".restart").addEventListener("click", (e) => {
  window.location.reload();
});

// Hides the start page from the user and starts the game
document.querySelector(".startButton").addEventListener("click", (e) => {
  const userX = parseInt(document.getElementById("xCells").value);
  const userY = parseInt(document.getElementById("yCells").value);
  startGame(userX, userY);
